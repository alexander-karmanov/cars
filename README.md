...
Сервис для размещения объявлений по продаже автомобилей.
...
<b>Hibernate</b> - ORM-фреймворк (Object-Relational Mapping) для Java
...
3. Добавить логин и пароль к созданной базе данных в ресурсные файлы 
